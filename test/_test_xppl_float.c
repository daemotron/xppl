...
bool __test_xppl_float_25(void);
bool __test_xppl_float_26(void);
bool __test_xppl_float_27(void);
bool __test_xppl_float_28(void);
bool __test_xppl_float_29(void);
bool __test_xppl_float_30(void);
...
_test_xppl_float_register(xppl_test_runner_t *tr)
{
    ...
    xppl_test_case_create(suite, __test_xppl_float_09, "xppl.float.f const 0.0 vs epsilon");
    xppl_test_case_create(suite, __test_xppl_float_10, "xppl.float.f const +epsilon vs -epsilon");
    xppl_test_case_create(suite, __test_xppl_float_11, "xppl.float.d zero matching");
    xppl_test_case_create(suite, __test_xppl_float_12, "xppl.float.d zero pos/neg");
    xppl_test_case_create(suite, __test_xppl_float_13, "xppl.float.d zero nan");
    xppl_test_case_create(suite, __test_xppl_float_14, "xppl.float.d zero infinity");
    xppl_test_case_create(suite, __test_xppl_float_15, "xppl.float.d const 1.0 vs 1.0");
    xppl_test_case_create(suite, __test_xppl_float_16, "xppl.float.d const 1.0 vs 1.1");
    xppl_test_case_create(suite, __test_xppl_float_17, "xppl.float.d const 1.0 vs 1.0 + 2 * epsilon");
    xppl_test_case_create(suite, __test_xppl_float_18, "xppl.float.d const 1.0 vs 1.0 + 3 * epsilon");
    xppl_test_case_create(suite, __test_xppl_float_19, "xppl.float.d const 0.0 vs epsilon");
    xppl_test_case_create(suite, __test_xppl_float_20, "xppl.float.d const +epsilon vs -epsilon");
    xppl_test_case_create(suite, __test_xppl_float_21, "xppl.float.l zero matching");
    xppl_test_case_create(suite, __test_xppl_float_22, "xppl.float.l zero pos/neg");
    xppl_test_case_create(suite, __test_xppl_float_23, "xppl.float.l zero nan");
    xppl_test_case_create(suite, __test_xppl_float_24, "xppl.float.l zero infinity");
    xppl_test_case_create(suite, __test_xppl_float_25, "xppl.float.l const 1.0 vs 1.0");
    xppl_test_case_create(suite, __test_xppl_float_26, "xppl.float.l const 1.0 vs 1.1");
    xppl_test_case_create(suite, __test_xppl_float_27, "xppl.float.l const 1.0 vs 1.0 + 2 * epsilon");
    xppl_test_case_create(suite, __test_xppl_float_28, "xppl.float.l const 1.0 vs 1.0 + 3 * epsilon");
    xppl_test_case_create(suite, __test_xppl_float_29, "xppl.float.l const 0.0 vs epsilon");
    xppl_test_case_create(suite, __test_xppl_float_30, "xppl.float.l const +epsilon vs -epsilon");
}
